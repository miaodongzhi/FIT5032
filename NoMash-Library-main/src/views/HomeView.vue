...
const validateReason = (blur) => {
  if (formData.value.reason !== formData.value.confirmReason) {
    if (blur) errors.value.confirmReason = 'Great to have a friend.'
  } else {
    errors.value.confirmReason = null
  }
}
</script>
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            ></textarea>
            <div v-if="errors.confirmReason" class="text-success">
                {{ errors.confirmReason }}
            </div>
          </div>
          <div class="mb-3">
